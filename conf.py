...
BLOG_AUTHOR = "MaaS Tech Japan" # (translatable)
...
BLOG_EMAIL = "tech@maas.co.jp"
BLOG_DESCRIPTION = "Technical Blog @ MaaS Tech Japan"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        'rsync -e "ssh -p 2222" -avz --delete ./output/ lolipop.jp-team-7@ssh469.lolipop.jp:web/tesshy.com/www/'
    ]
}
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-128785619-2"></script>
<script>
...
#     'creator': '@tesshy',     # Username for the content creator / author.
# }
